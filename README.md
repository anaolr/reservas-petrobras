...
<img src="https://github.com/user-attachments/assets/63e979be-bae0-4576-90e4-8887bb1d564d" width="420" alt="Petrobras Logo">

# 🛢️ **Sistema de Reservas — Petrobras**
...
Seu objetivo é garantir que reuniões, treinamentos e eventos sigam regras de prioridade, disponibilidade e segurança, reduzindo conflitos e automatizando processos internos.

---

## 🏛️ **Auditórios Disponíveis**
...
- **JavaScript Vanilla (DOM, eventos, validações)**  
- **Responsividade com media queries**  

**Design e UX:**
- Paleta oficial Petrobras  
- Layout corporativo  
- Acessibilidade e alto contraste  
- Componentes reutilizáveis (tabelas, painéis, cards, modais)
...
- Bloqueio de horários indisponíveis (lado visual)  
- Fluxo guiado no processo de reserva  
...
<div align="center">
<img width="1904" height="876" alt="Captura de tela 2025-11-14 144537" src="https://github.com/user-attachments/assets/6b60a6f0-8a8d-47f2-9ec3-515443fcd2e7" />
<img width="1895" height="827" alt="Captura de tela 2025-11-14 144521" src="https://github.com/user-attachments/assets/a4e8bc7c-5c51-401e-b7b6-5c40a43dc5df" />
